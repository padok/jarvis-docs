...
Before you dive into our manual, here are some notes to help you find what you need:
- If you want to get an overview of what JARVIS can and can't do our Paper might be a good starting point.
- This Manual covers all the basic steps you need to take to get from the idea of using markerless tracking to 3D pose predictions ready for analysis.
